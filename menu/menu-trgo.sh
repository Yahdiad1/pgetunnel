...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Yahdiad1/pgetunnel/main/register > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Yahdiad1/pgetunnel/main/register | grep $MYIP | awk '{print $2}')

...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/Yahdiad1/pgetunnel/main/ssh/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/Yahdiad1/pgetunnel/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
